...
def create_file_for_value(dict, path_direction):
    ...
    for item in dict:
        ...
        seq = find_seq(item, data_path + f'/{sequence_file}')
        if seq == None:
            continue

        try:
            with open(f"{path_direction}/{dict[item]}.txt".replace(' ', ''), "a") as file:
                print(f"{item}\t{dict[item]}\n{find_seq(item, data_path + f'/{sequence_file}')}", file=file, end='')
        except:
...
check_existence_folder(data_path + "/pHMM_associate_files", True)
check_existence_folder(data_path + "/pHMM_associate_files/class", True)
check_existence_folder(data_path + "/pHMM_associate_files/class/small", True)
check_existence_folder(data_path + "/pHMM_associate_files/class/large", True)
...
create_file_for_value(small_class, f"{data_path}/pHMM_associate_files/class/small/")
create_file_for_value(large_class, f"{data_path}/pHMM_associate_files/class/large/")
